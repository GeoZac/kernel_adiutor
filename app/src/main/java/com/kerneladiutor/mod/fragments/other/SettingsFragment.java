...
package com.kerneladiutor.mod.fragments.other;
...
import com.kerneladiutor.mod.services.BootService;
...
public class SettingsFragment extends RecyclerViewFragment {
    ...
    private void dumpsysfs() {
        ...
        try {
            ...
            Uri uri = FileProvider.getUriForFile(getActivity(), "com.kerneladiutor.mod.fileprovider", sysfsdump);
