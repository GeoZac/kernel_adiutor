...
package com.kerneladiutor.mod.tasker;
...
public final class PluginBundleManager {
     ...
     */
    public static final String BUNDLE_EXTRA_STRING_MESSAGE = "com.kerneladiutor.mod.tasker.extra.STRING_MESSAGE"; //$NON-NLS-1$
    ...
    public static final String BUNDLE_EXTRA_INT_VERSION_CODE =
            "com.kerneladiutor.mod.tasker.extra.INT_VERSION_CODE"; //$NON-NLS-1$
